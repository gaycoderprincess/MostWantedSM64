...
#define SOUND_ARG_LOAD(bank, playFlags, soundID, priority, flags2) (((uint32_t) (bank) << 28)       | \
                 ((uint32_t) (playFlags) << 24) | ((uint32_t) (soundID) << 16) | ((uint32_t) (priority) << 8) | \
                 ((uint32_t) (flags2)  << 4)  |  SOUND_STATUS_STARTING)
